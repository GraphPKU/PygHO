...
from subgnn.SpXOperator import pooling2nodes
import torch.nn as nn
from backend.SpTensor import SparseTensor
from subgnn.utils import MLP
from subgnn.Emb import x2dims, MultiEmbedding, SingleEmbedding
...
class I2GNN(nn.Module):
    ...
    def __init__(self,
        ...
        self.subggnns = Convs(
            [I2Conv(emb_dim, **kwargs["conv"]) for i in range(num_layer)],
            residual=residual)
    ...
    def forward(self, datadict: dict):
        ...
        x = pooling2nodes(X, dims=[0, 1], pool=self.lpool)
